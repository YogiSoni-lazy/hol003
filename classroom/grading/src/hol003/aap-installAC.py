...
class AapInstallac(Default):
    __LAB__ = "aap-installAC"
    ...
    def grade(self):
        items = [
            ...
            steps.run_command(
                label="Checking automation-controller status on " + _workstation,
                hosts=[_workstation],
                command="""sudo systemctl status automation-controller""",
                returns="0",
                shell=True,
            ),
        ]
